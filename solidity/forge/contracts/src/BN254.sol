...
library BN254 {
        ...
        returns (bool)
    {
        ...
        // TODO commented for now as our pairing check fail
        // require(success, "Bn254: Pairing check failed!");
        return (out != 0);
    }

    // TODO check if this is correct. Taken from https://github.com/tornadocash/tornado-core/blob/1ef6a263ac6a0e476d063fcb269a9df65a1bd56a/contracts/Verifier.sol#L112 and slightly modified
    function pairing4(G1Point[4] memory p1, G2Point[4] memory p2) internal view returns (bool) {
    ...
    // TODO check if this is correct. ADAPTED from pairing4 above
    function pairing3(G1Point[3] memory p1, G2Point[3] memory p2) internal view returns (bool) {
        uint256 inputSize = 18; // 6*3
        uint256[] memory input = new uint256[](inputSize);
    ...
    // TODO check if this is correct. ADAPTED from pairing4 above
    function pairing15(G1Point[15] memory p1, G2Point[15] memory p2) internal view returns (bool) {
        uint256 inputSize = 90; // 6 * 15
        uint256[] memory input = new uint256[](inputSize);
